...
public class ArtifalityTranslations {
    ...
    public static void init(RuntimeResourcePack pack){
        ...
        ArtifalityEnchantments.getEnchantments().forEach((id, enchantment) -> pack.addLang(EN_US, LANG.enchantment(enchantment, ((IArtifalityEnchantment) enchantment).getTranslation())));
    ...
    private static void miscTranslations(RuntimeResourcePack pack){
        pack.addLang(EN_US, LANG.itemGroup(new Identifier(ArtifalityMod.MODID, "general"), "Artifality Items"));
    }
}
