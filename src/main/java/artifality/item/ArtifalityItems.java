...
public class ArtifalityItems extends ItemRegistry {
    ...
    public static final Item FLORAL_STAFF = add("floral_staff", new NatureStaffItem(settings().maxCount(1)));
    public static final Item FOREST_STAFF = add("forest_staff", new ForestStaffItem(settings().maxCount(1)));
    public static final Item HARVEST_STAFF = add("harvest_staff", new NatureStaffItem(settings().maxCount(1)));
