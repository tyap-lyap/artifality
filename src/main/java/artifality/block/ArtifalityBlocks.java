...
public class ArtifalityBlocks {
    ...
    public static final Block INCREMENTAL_CLUSTER = add("incremental_cluster", new CrystalBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).sounds(BlockSoundGroup.AMETHYST_CLUSTER).luminance(value -> 7), "Incremental Cluster"));
    public static final Block INCREMENTAL_BLOCK = add("incremental_block", new BaseBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).sounds(BlockSoundGroup.GLASS), "cube_all", "Incremental Block"));
    ...
    public static final Block LUNAR_CRYSTAL_CLUSTER = add("lunar_crystal_cluster", new CrystalBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).sounds(BlockSoundGroup.AMETHYST_CLUSTER).luminance(value -> 7), "Lunar Crystal Cluster"));
    ...
    public static final Block CRYSTAL_HEART_CLUSTER = add("crystal_heart_cluster", new CrystalBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).sounds(BlockSoundGroup.AMETHYST_CLUSTER).luminance(value -> 7), "Crystal Heart Cluster"));
