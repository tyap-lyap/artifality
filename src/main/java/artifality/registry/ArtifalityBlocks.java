...
import artifality.registry.base.BlockRegistryBase;
...
public class ArtifalityBlocks extends BlockRegistryBase {
...
//    public static final Block WRATH_ORB = add("wrath_orb", new OrbBlock(copyOf(WHITE_WOOL).sounds(BlockSoundGroup.AMETHYST_BLOCK).luminance(15).nonOpaque()));
    ...
    public static final Block INCREMENTAL_CRYSTAL_GEODE = geode("incremental_crystal_geode", SMALL_INCREMENTAL_CRYSTAL_CLUSTER, MEDIUM_INCREMENTAL_CRYSTAL_CLUSTER, INCREMENTAL_CRYSTAL_CLUSTER);
    ...
    public static final Block LUNAR_CRYSTAL_GEODE = geode("lunar_crystal_geode", SMALL_LUNAR_CRYSTAL_CLUSTER, MEDIUM_LUNAR_CRYSTAL_CLUSTER, LUNAR_CRYSTAL_CLUSTER);
    ...
    public static final Block LIFE_CRYSTAL_GEODE = geode("life_crystal_geode", SMALL_LIFE_CRYSTAL_CLUSTER, MEDIUM_LIFE_CRYSTAL_CLUSTER, LIFE_CRYSTAL_CLUSTER);
...
//
//    public static final Block WRATH_CRYSTAL_GEODE = geode("wrath_crystal_geode", SMALL_WRATH_CRYSTAL_CLUSTER, MEDIUM_WRATH_CRYSTAL_CLUSTER, WRATH_CRYSTAL_CLUSTER);
//
...
//    public static final Block LUNAR_PEDESTAL = add("lunar_pedestal", new BaseBlock(copyOf(COBBLESTONE)));
    ...
    public static final Block BUDDING_LUNAR_CRYSTAL = geode("budding_lunar_crystal", SMALL_LUNAR_CRYSTAL_CLUSTER, MEDIUM_LUNAR_CRYSTAL_CLUSTER, LUNAR_CRYSTAL_CLUSTER);
    public static final Block BUDDING_LIFE_CRYSTAL = geode("budding_life_crystal", SMALL_LIFE_CRYSTAL_CLUSTER, MEDIUM_LIFE_CRYSTAL_CLUSTER, LIFE_CRYSTAL_CLUSTER);
